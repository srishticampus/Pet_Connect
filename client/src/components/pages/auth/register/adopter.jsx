  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Adopter Sign Up</CardTitle>
          <CardDescription>Enter your details to register as an adopter.</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <CardFooter>
              <Button type="submit">Register as Adopter</Button>
            </CardFooter>
          </form>
        </CardContent>
      </Card>
